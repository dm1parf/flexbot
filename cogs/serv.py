...
from bottools import wordend, data_read, data_write, exp
...
class Serv(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        embed = discord.Embed(
            ...
            description=f'{member.mention} добро пожаловать на сервер **{member.guild.name}**:heart_exclamation:\n\n'
        )
    ...
    async def set_roles_(self, ctx, *role: typing.Union[discord.Role, str]):
        try:
            ...
            await ctx.send("Слишком много ролей без эмоджи. Попробуй заполнить их своими смайлами.")
